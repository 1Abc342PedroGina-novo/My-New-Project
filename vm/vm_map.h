...
#define vme_end			links.end
	...
	unsigned short		user_wired_count; /* for vm_wire */
 	union {
		...
		u64 vm_freeptr; /* Pointer used by SLAB_TYPESAFE_BY_RCU */
	};
	union {
...
struct vm_context {
      ...
      atomic_t     tlb_gen;
      void *machdylib;
      struct mutex      *mutex_of_thread;
      struct i386_fpsave_state    *fpsave;
      struct i386_saved_state *saved;
...
unsigned long task_size;	/* size of task vm space */
    ...
    atomic_t    pinned_vm;   /* Refcount permanently increased */
